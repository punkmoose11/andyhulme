...
games <- read_excel("C://Users/andyh/OneDrive/Documents/SPORTSDATA/Raw/woso.xlsx",sheet = "Sheet1")
games <- as.data.frame(games) 

seeds <- read_excel("C://Users/andyh/OneDrive/Documents/SPORTSDATA/Raw/woso.xlsx",sheet = "Sheet2")
...
games1.x <- games1[c("year","rd","round","gameno","oteam1","oscore1","oteam2","oscore2","ot")]
